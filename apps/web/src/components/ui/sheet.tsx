  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          isCenter
            ? "bg-background fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 flex flex-col rounded-lg shadow-lg w-full max-w-lg max-h-[90vh] overflow-hidden"
          ...
          <SheetClose
            render={
              <Button
                ...
                className={cn(
                  "absolute",
                  isCenter ? "top-3 right-3" : "top-3 right-3"
                )}
                size="icon-sm"
              />
            }
